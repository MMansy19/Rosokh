        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted max-w-2xl mx-auto">
            {messages?.quran?.description ||
              "Read the Quran with beautiful Arabic text"}
          </p>
        </div>
              ...
              {loading ? (
                ...
                <div className="space-y-6">
                  {ayahs.map((ayah) => (
                    <div
                      key={ayah.number}
                      className="group p-4 rounded-lg hover:bg-secondary transition-all duration-200 border border-transparent hover:border-border"
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <p className="text-2xl font-amiri leading-loose text-foreground text-right mb-4">
                            {ayah.text}
                          </p>
                          {readingMode === "transliteration" && (
                            <p className="text-lg text-muted italic mb-2">
                          ...
                          {readingMode === "translation" && (
                            <p className="text-lg text-muted">
                              {messages?.quran?.translationNotAvailable ||
