...
const QuranReader = ({ locale, messages }: QuranReaderProps) => {
  ...
  const getPageStyle = (direction: "next" | "prev") => {
    ...
    if (direction === "next" && dragDistance < 0) {
      rotation = Math.max(
        -maxRotation,
        (dragDistance / (bookWidth / 2)) * maxRotation,
      );
                ...
                {leftPage >= 1 && (
                  <div
                    className={classNames("page left", {
                      flipped:
                        flipDirection === "next" && clickedPage === "left",
                    })}
                    ...
                    onMouseLeave={(e) =>
                      dragStart !== null && handleMouseUp(e, "prev")
                    }
                ...
                {rightPage <= TOTAL_PAGES && (
                  <div
                    className={classNames("page right", {
                      flipped:
                        flipDirection === "prev" && clickedPage === "right",
                    })}
                    ...
                    onMouseLeave={(e) =>
                      dragStart !== null && handleMouseUp(e, "next")
                    }
