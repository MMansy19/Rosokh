    ...
    switch (action) {
      case 'list-folder':
        ...
        const folderContents = await drive.files.list({
          ...
          fields: 'files(id, name, size, mimeType, webContentLink, createdTime, modifiedTime)',
        });
      ...
      case 'get-file-info':
        ...
        const fileInfo = await drive.files.get({
          fileId,
          fields: 'id, name, size, mimeType, webContentLink, createdTime, modifiedTime',
        });
    ...
    switch (action) {
      case 'list-audio-files':
        ...
        const audioFiles = await drive.files.list({
          q: query,
          fields: 'files(id, name, size, mimeType, parents, webContentLink, createdTime, modifiedTime)',
