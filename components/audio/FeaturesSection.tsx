  ...
  const features = [
    {
      ...
      description: "Download high-quality Islamic audio content for offline listening",
    ...
    },
    {
      ...
      description: "Save your favorite recitations and build your personal collection",
    ...
    },
    {
      ...
      title: "Smart Search",
      description: "Find specific surahs, reciters, or topics with intelligent search",
    ...
    },
    {
      ...
      description: "Crystal clear sound with multiple quality options for your preference",
    ...
    },
    {
      ...
      description: "Seamless experience across all devices - phone, tablet, and desktop",
    ...
    },
    {
      ...
      title: "Safe & Secure",
      description: "Trusted content from verified reciters with secure streaming",
    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-br from-muted/20 via-background to-muted/10 rounded-2xl border border-border/50 p-8 backdrop-blur-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Experience the best Islamic audio platform with features designed for modern Muslims
          </p>
        </div>
          ...
          {highlights.map((highlight, index) => (
            <div key={index} className="text-center">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <div className="text-2xl font-bold text-primary">{highlight.stat}</div>
              </div>
      ...
      <div className="text-center bg-gradient-to-br from-card via-card/95 to-card/90 rounded-xl p-8 border border-border/50">
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <h4 className="text-xl font-semibold text-foreground">Join Our Community</h4>
        </div>
        <p className="text-muted-foreground mb-6 max-w-md mx-auto">
          Access thousands of Islamic audio tracks from renowned reciters around the world
        </p>
