...
export const MainStatsGrid: React.FC<MainStatsGridProps> = React.memo(({ 
  ...
  const statsData = [
    ...
    },
    {
      ...
      label: getTranslation(messages, 'audio.stats.totalDuration', 'Total Duration'),
      colorClass: 'bg-green-100 dark:bg-green-950 text-green-600 dark:text-green-400',
    ...
    },
    {
      ...
      colorClass: 'bg-purple-100 dark:bg-purple-950 text-purple-600 dark:text-purple-400',
      ariaLabel: getTranslation(messages, 'audio.stats.hdQuality', 'HD Quality available')
    }
  ];
  ...
  return (
    <section 
      ...
      aria-label={getTranslation(messages, 'audio.stats.mainStatsLabel', 'Main statistics')}
    >
